...
while True:
    ...
    grayDilate = cv.dilate(grayCanny, kernel, iterations=1)
    grayBlurDilate = cv.dilate(grayCanny, kernel, iterations=1)
    ...
    imgStack = stackImages(.4, ([imgGray, imgBlank, grayBlur],
                                ...
                                [grayDilate, drawing, grayBlurDilate]))
